...
public class comp_cs : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		else //Human
		{
			...
			else if (Input.GetKey (KeyCode.LeftShift) && Input.GetKey (KeyCode.UpArrow)) anim.SetInteger ("State", 3); //Run
			else if (Input.GetKey (KeyCode.UpArrow)) anim.SetInteger ("State", 1); //Walk
			else if (Input.GetKey (KeyCode.DownArrow)) anim.SetInteger ("State", -1); //Steps Back
			else if (Input.GetKey (KeyCode.LeftArrow)) anim.SetInteger ("State", 10); //Strafe+
			else if (Input.GetKey (KeyCode.RightArrow))anim.SetInteger ("State", -10); //Strafe-
			else anim.SetInteger ("State", 0); //Idle

			//Turn
			if(Input.GetKey(KeyCode.LeftArrow)&& velZ!=0)ang = Mathf.Lerp(ang,-4.0f,0.025f);
			else if(Input.GetKey(KeyCode.RightArrow)&& velZ!=0) ang = Mathf.Lerp(ang,4.0f,0.025f);
